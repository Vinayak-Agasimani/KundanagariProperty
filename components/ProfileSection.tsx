...
const ProfileSection = () => {
  return (
    <section className="min-h-screen py-40 px-8 flex flex-col items-center justify-center border-t border-white/5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center w-full">
        ...
        >
          <div className="space-y-6">
            <h3 className="text-white/30 text-[10px] tracking-[0.6em] uppercase font-medium">
              Belgaum Real Estate
            </h3>
          ...
          <div className="pt-12 grid grid-cols-2 gap-12 border-t border-white/5">
            <div className="space-y-2">
              <div className="text-white text-3xl font-black tracking-tighter">500+</div>
              <div className="text-white/20 text-[9px] tracking-[0.3em] uppercase">Properties Listed</div>
            </div>
            <div className="space-y-2">
              <div className="text-white text-3xl font-black tracking-tighter">100+</div>
              <div className="text-white/20 text-[9px] tracking-[0.3em] uppercase">Happy Clients</div>
            </div>
          </div>
        </motion.div>
      </div>
