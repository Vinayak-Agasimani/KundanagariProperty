    ...
    <section className="min-h-screen py-40 px-8 flex flex-col items-center justify-center border-t border-white/5 bg-[#000000]">
      <div className="w-full space-y-32 text-center">
        <motion.div 
          ...
          className="space-y-8"
        >
          <h2 className="text-7xl md:text-[12rem] font-black text-white tracking-[-0.06em] leading-[0.8] uppercase select-none">
            Let&apos;s <br/> Connect
          </h2>
          <p className="text-white/30 text-[10px] md:text-sm tracking-[0.5em] uppercase w-full mx-auto font-medium">
            Your trusted partner for buying, selling, renting, and investing in Belgaum properties.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 items-start text-left w-full">
